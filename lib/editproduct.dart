...
class _EditProductState extends State<EditProduct> {
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          fit: BoxFit.fill,
                          imageUrl:
                              "https://noraida.xyz/decor/productimage/${widget.product.pid}.jpg",
  ...
  updateProduct() {
    ...
    pr.style(message: "Updating product details . . .");
    pr.show();
    String base64Image; 
    
    if (_image!=null){
       base64Image = base64Encode(_image.readAsBytesSync());
      http.post("https://noraida.xyz/decor/php/update_product.php", body: {
