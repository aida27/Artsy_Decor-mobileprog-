...
class _ProfileScreenState extends State<ProfileScreen> {
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                   "https://noraida.xyz/decor/profileimages/user@noregister.jpg?",
  ...
  void _takePicture() async {
    ...
    if (_image == null) {
      ...
      print(base64Image);
      http.post("https://noraida.xyz/decor/php/upload_image.php", body: {
  ...
  _changeName(String name) {
    ...
    http.post("https://noraida.xyz/decor/php/update_profile.php", body: {
      "email": widget.user.email,
