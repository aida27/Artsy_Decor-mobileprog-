...
import 'package:decor/editproduct.dart';
import 'package:decor/newproduct.dart';
import 'package:decor/product.dart';
import 'package:decor/user.dart';
...
class _AdminProductState extends State<AdminProduct> {
  ...
  void _deleteProduct(int index) {
    ...
    pr.show();
    http.post("https://noraida.xyz/decor/php/delete_product.php", body: {
