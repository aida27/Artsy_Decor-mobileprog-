...
class _CartScreenState extends State<CartScreen> {
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: ClipOval(
                                            ...
                                            imageUrl:
                                                "https://noraida.xyz/decor/productimage/${cartData[index]['id']}.jpg",
  ...
  void _loadCart() {
    ...
    pr.show();
    String urlLoadJobs =
        "https://noraida.xyz/decor/php/load_cart.php";
  ...
  _updateCart(int index, String op) {
    ...
    String urlLoadJobs =
        "https://noraida.xyz/decor/php/update_cart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
      ...
      builder: (context) => new AlertDialog(
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                Navigator.of(context).pop(false);
                http.post("https://noraida.xyz/decor/php/delete_cart.php",
                    body: {
                      "email": widget.user.email,
                    }).then((res) {
                  print(res.body);
