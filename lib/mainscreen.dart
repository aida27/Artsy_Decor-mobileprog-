...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    ...
    refreshKey = GlobalKey<RefreshIndicatorState>();
     if (widget.user.email == "admin@decor.com") {
      _isadmin = true;
     }
  }
 ...
 return WillPopScope(
                                ...
                                children: <Widget>[
                                  GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        imageUrl:
                                         "https://noraida.xyz/decor/productimage/${productdata[index]['id']}.jpg",
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
              if (widget.user.email == "unregistered") {
                ...
                return;
              } else if (widget.user.email == "admin@decor.com") {
  ...
  void _loadData() {
    String urlLoadJobs = "https://noraida.xyz/decor/php/load_products.php";
  ...
  void _loadCartQuantity() async {
    String urlLoadJobs = "https://noraida.xyz/decor/php/load_cartquantity.php";
  ...
  void _addtoCart(int index) {
    ...
    try {
      ...
      if (cquantity > 0) {
        ...
        pr.show();
        String urlLoadJobs =
            "https://noraida.xyz/decor/php/insert_cart.php";
  ...
  void _sortItem(String type) {
    try {
      ...
      pr.show();
      String urlLoadJobs =
          "https://noraida.xyz/decor/php/load_products.php";
      http.post(urlLoadJobs, body: {
        "type": type,
      }).then((res) {
        setState(() {
